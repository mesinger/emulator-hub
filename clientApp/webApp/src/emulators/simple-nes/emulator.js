...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'emulators/SimpleNES/build/emulator.data';
      var REMOTE_PACKAGE_BASE = 'emulator.data';
...
Module['FS_createPath']("/", "emulators", true, true);
Module['FS_createPath']("/emulators", "SimpleNES", true, true);
Module['FS_createPath']("/emulators/SimpleNES", "roms", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_emulators/SimpleNES/build/emulator.data');

      };
      Module['addRunDependency']('datafile_emulators/SimpleNES/build/emulator.data');
    ...
    loadPackage({"files": [{"filename": "/emulators/SimpleNES/roms/firedemo.nes", "start": 0, "end": 40976}], "remote_package_size": 40976});
